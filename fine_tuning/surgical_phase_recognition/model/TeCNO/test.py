...
def train(hparams, ModuleClass, ModelClass, DatasetClass, logger):
    ...
    trainer.test(ckpt_path=hparams.resume_from_checkpoint, model=module, verbose=True)
...
if __name__ == "__main__":
    ...
    parser.add('-bm', '--best_model', type=str, default='surgical_phase_recognition', help='module to use')
