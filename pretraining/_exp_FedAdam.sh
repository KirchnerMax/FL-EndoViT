...
# Experiment 2F - FL-EndoViT FedAdam Segmentation w/out ASAM
python simulation_main.py log_dir=$ROOT_DIR/%j/experiment_2F/ \
Server.output_dir=$ROOT_DIR/experiment_2F/Server \
