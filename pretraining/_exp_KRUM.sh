...
# Experiment 2D - FL-EndoViT KRUM Segmentation w/out ASAM
python simulation_main.py log_dir=$ROOT_DIR/%j/experiment_2D/ \
Server.output_dir=$ROOT_DIR/experiment_2D/Server \
