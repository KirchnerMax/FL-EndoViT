...
class BaseModel(nn.Module):
    ...
    def __init__(self, basename='resnet18', hr_output=False, *args, **kwargs):
        ...
        if basename == 'mae':
            ...
            self.basemodel      = prepare_mae_model(
                                        kwargs["mae_model"], # default: vit_base_patch16 model type
            ...
            OUT_HEIGHT = 14
            OUT_DITH = 14
            print("MAE uses different resolution outputs ({}x{})".format(OUT_HEIGHT,OUT_WIDTH))
    ...
    def increase_resolution(self):  
        ...
        OUT_HEIGHT *= 4
        OUT_WIDTH  *= 4
        print("using high resolution outputs ({}x{})".format(OUT_HEIGHT,OUT_WIDTH))
