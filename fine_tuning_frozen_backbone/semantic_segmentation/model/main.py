...
def main():
    ...
    # Note: The outputs files go to directory named as 'output_dir/run_{run_number}_{date_and_time}_{run_name}'.
    ...
    # Redirecting std_out and std_err to the outputs folder.
