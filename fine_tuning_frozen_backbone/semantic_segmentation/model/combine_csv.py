...
if __name__ == "__main__":
    csv_1 = "/mnt/ceph/tco/TCO-Staff/Homes/kirchnema/04_pycharm/05_endovit_fl/03_EndoViT_FL_2/EndoViT_2/1_vid_only_experiments_log_sss_frozen.csv"
    csv_2 = "/mnt/ceph/tco/TCO-Staff/Homes/kirchnema/04_pycharm/05_endovit_fl/03_EndoViT_FL_2/EndoViT_2/2_vids_only_experiments_log_sss_frozen.csv"
    csv_4 = "/mnt/ceph/tco/TCO-Staff/Homes/kirchnema/04_pycharm/05_endovit_fl/03_EndoViT_FL_2/EndoViT_2/4_vids_only_experiments_log_sss_frozen.csv"
    csv_total = "/mnt/ceph/tco/TCO-Staff/Homes/kirchnema/04_pycharm/05_endovit_fl/03_EndoViT_FL_2/EndoViT_2/_experiments_log_sss_frozen.csv"
    ...
    new_data_1 = convert_old_to_new_format(csv_1, n_videos="1", output_csv="sss_frozen.csv")
    new_data_2 = convert_old_to_new_format(csv_2, n_videos="2", output_csv="sss_frozen.csv")
    new_data_4 = convert_old_to_new_format(csv_4, n_videos="4", output_csv="sss_frozen.csv")
    new_data_t = convert_old_to_new_format(csv_total, n_videos="total", output_csv="sss_frozen.csv")
